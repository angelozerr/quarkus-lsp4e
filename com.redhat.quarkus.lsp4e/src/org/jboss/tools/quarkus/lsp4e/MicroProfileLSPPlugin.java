 ...
 * @author Angelo ZERR
 */
public class MicroProfileLSPPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "org.boss.tools.quarkus.lsp4e"; //$NON-NLS-1$

	// The shared instance
	private static MicroProfileLSPPlugin plugin;

	/**
	 * The constructor
	 */
	public MicroProfileLSPPlugin() {
	}
	 ...
	 */
	public static MicroProfileLSPPlugin getDefault() {
		return plugin;
	}

	public static String getPluginId() {
		return MicroProfileLSPPlugin.PLUGIN_ID;
	}
