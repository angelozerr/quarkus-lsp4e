 ...
 *
 */
public class MicroProfileLanguageClient extends LanguageClientImpl implements MicroProfileLanguageClientAPI {
	...
	public MicroProfileLanguageClient() {
	...
	public CompletableFuture<MicroProfileProjectInfo> getProjectInfo(MicroProfileProjectInfoParams params) {
		return CompletableFutures.computeAsync((cancelChecker) -> {
			...
			try {
				return PropertiesManager.getInstance().getMicroProfileProjectInfo(params, JDTUtilsImpl.getInstance(),
						monitor);
			} catch (Exception e) {
